...
class Config:
    ...
    def arg_parse() -> tuple:
        ...
        parser.add_argument(
            "--force_fp32", action="store_true", help="Forces FP32 precision mode"
        )
    ...
    def device_config(self):
        if torch.cuda.is_available():
            ...
            if self.force_fp32 or (
                ...
                logger.info("Your GPU (%s) does not support FP16 or --force_fp32 flag is used. Running in FP32 mode.", self.gpu_name)
                self.is_half = False
