...
from rvc.synthesizer_vc import get_synthesizer, load_synthesizer
...
class VC:
    ...
    def get_vc(self, sid, *to_return_protect):
        ...
        to_return_protect0 = {
            ...
            "value": (
                to_return_protect[0] if self.if_f0 != 0 and len(to_return_protect) > 0 else 0.5
            ),
            "__type__": "update",
        }
        to_return_protect1 = {
            "visible": self.if_f0 != 0,
            "value": (
                to_return_protect[1] if self.if_f0 != 0 and len(to_return_protect) > 1 else 0.33
            ),
            "__type__": "update",
        }

        # Ensure to_return_protect has at least 4 elements for indexing later
        to_return_protect = list(to_return_protect) + [None] * (4 - len(to_return_protect))
