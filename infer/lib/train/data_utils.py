...
class TextAudioLoaderMultiNSFsid(torch.utils.data.Dataset):
    ...
    def __init__(self, hparams):
        ...
        self.sample_rate = hparams.sampling_rate # 48000
        self.filter_length = hparams.filter_length # 2048
        self.hop_length = hparams.hop_length # 480
    ...
    def get_audio(self, filename):
        ...
        # DEBUG
        # Check the number of dimensions of the audio tensor

        #if audio.dim() == 1:
            #print(f"/// data_utils /// Loaded mono audio wave from {filename} with {audio.size(0)} samples.")
        #elif audio.dim() == 2:
            #print(f"/// data_utils /// Loaded multi-channel audio wave from {filename} with {audio.size(1)} samples per channel.")
        #else:
            #print(f"/// data_utils /// Unexpected audio shape: {audio.shape}")
