    ...
    def forward(
        ...
        if y is not None:
            ...
            if self.use_f0 and pitchf is not None:
                ...
                # Decode using all shuffled slices of z and pitchf
                o = self.dec(all_z_slices, pitchf_slices, g=g)
            else:
                # Decode using all shuffled slices of z
                o = self.dec(all_z_slices, g=g)
