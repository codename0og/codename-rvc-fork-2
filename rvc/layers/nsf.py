...
from rvc.layers.generators import SineGenerator #SineGenerator
from rvc.layers.residuals import ResBlock1, ResBlock2, LRELU_SLOPE #
from rvc.layers.utils import call_weight_data_normal_if_Conv #
...
class SourceModuleHnNSF(torch.nn.Module):
    ...
    def __init__(
        ...
        self.l_sin_gen = SineGenerator( #SineGen
