...
from rvc.layers.discriminators.sub.__init__ import MultiScaleSTFTDiscriminator
from rvc.layers.discriminators.sub.__init__ import MultiScaleSubbandCQTDiscriminator
from rvc.layers.discriminators.sub.__init__ import MultiPeriodDiscriminator
